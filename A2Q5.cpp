...
void PrintPatternQ5(int x, int y,int z)
{
    ...
    print (x,' '); // as x is now 1, so print spaces accoring to it as now spaces are starting from one
	print (((2*z))-((2*x)-1),'*'); // calling print function to print stars. z=5,x=1....  ((2*5)-2)-((2*1)-1)=8-1=7 stars and so on
	cout<<"\n";
